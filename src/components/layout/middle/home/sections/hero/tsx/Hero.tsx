...
import styleRightMessage from "../styles/right/message/hero.right.message.module.css";
import styleLeftPulseEffect from "../styles/left/hero.left.pulseEffect.module.css";
import styleRightMessagePulseEffect from "../styles/right/message/hero.right.pulseEffect.module.css";
